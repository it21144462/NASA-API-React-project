...
import { faYoutube, faInstagram, faSpaceAwesome } from '@fortawesome/free-brands-svg-icons';
  ...
  return (
    <footer className="bg-black-500 p-4 text-white text-center mt-10 ">
      <div className="container mx-auto flex flex-col items-center ">
        ...
        <div>
          <p className="text-sm">&copy; 2024 NASA APIs Weather Tracker. All rights reserved.</p>
          <p className="text-sm">Designed by TRR</p>
        </div>
      </div>
    </footer>
  )
